...
export const asyncRoutes = [
  {
    ...
    meta: {
      title: 'Permission',
      icon: 'lock',
      perms: ['admin', 'editor'] // you can set perms in root nav
    },
    children: [
      {
        path: 'page',
        ...
        meta: {
          ...
          perms: ['admin'] // or you can only set perms in sub nav
        }
      },
      {
        path: 'directive',
        ...
        meta: {
          ...
          // if do not set perms, means: this page does not require permission
        }
      },
      {
        path: 'role',
